...
- [x] Audit M23 evidence and freeze the M24 evaluation specification.
- [x] Add failing replay, bootstrap, grouping, calibration, and acceptance tests.
- [x] Implement frozen LightGBM replay and complete-key analysis table.
- [x] Implement global and paired series-level bootstrap.
