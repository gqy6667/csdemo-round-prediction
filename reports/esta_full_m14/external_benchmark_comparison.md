...
|---|---|---|---|---:|---:|---:|---|
| [Predicting the outcome of a round in CS:GO using a DNN](https://nikolaiaakerholt.com/posts/projects/academic/csgoroundwinningpredictor/Deep_Learning_CourseProject_Report.pdf) | Deep neural network | RoundFreezetimeEnd | accuracy | 0.647411 | 0.679220 | -3.18 个百分点 | 我们的模型较差 0.031809 |
| [Predicting the outcome of a round in CS:GO using a DNN](https://nikolaiaakerholt.com/posts/projects/academic/csgoroundwinningpredictor/Deep_Learning_CourseProject_Report.pdf) | Deep neural network | RoundFreezetimeEnd | log_loss | 0.591733 | 0.567860 | +0.023873 | 我们的模型较差 0.023873 |

## 不可直接比较

| 外部工作 | 模型 | 时点 | 指标 | 我们 | 外部 | 原始差值 | 方向修正后 |
|---|---|---|---|---:|---:|---:|---|
| [CS:GO Round Winner Classification](https://github.com/anantoj/csgo-round-winner-classification) | Random forest | In-round snapshots | accuracy | 0.647411 | 0.884100 | -23.67 个百分点 | 仅数值差，不判断优劣 |
| [Prediction of CS:GO Round Results with ML Techniques](https://doi.org/10.38016/jista.1235031) | Random forest | In-round snapshots | accuracy | 0.647411 | 0.880000 | -23.26 个百分点 | 仅数值差，不判断优劣 |
