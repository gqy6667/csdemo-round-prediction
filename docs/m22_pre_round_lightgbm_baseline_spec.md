...
M22 正式运行于 LightGBM `4.6.0` CPU，validation 最佳迭代为 115。13/13 阻断项、
155 项完整测试和源码编译全部通过。

| 模型 | Accuracy | AUC | Log Loss | Brier | ECE10 |
|---|---:|---:|---:|---:|---:|
| 冻结 XGBoost | 0.647411 | 0.727122 | 0.591733 | 0.205294 | 0.023198 |
| M22 LightGBM | 0.650767 | 0.727846 | 0.591437 | 0.205201 | 0.018875 |

LightGBM 在五项点指标上均略好，但 AUC 只增加 `0.000724`，Log Loss 只下降
`0.000296`，目前不能声称有显著算法优势。五项最低门槛全部通过，更高目标只有 ECE10
通过。正式模型对比、目标差和外部差值见
